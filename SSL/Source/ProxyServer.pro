...
INCLUDEPATH += \
    ...
    C:/ProgrammingLibs/openssl-master/include # Change to openssl directory
...
LIBS += \
    ...
    -l:libssl.lib \ # Change to compiled ssl lib
    -l:libcrypto.lib \ # Change to libcrypto ssl lib
    -L"C:/Program Files/OpenSSL/lib" # Change to compiled SSL libs location
